...
const features: Feature[] = [
  ...
  },
  {
    ...
    description:
      "Real-time attendee tracking and seamless guest list management.",
  },
  {
    icon: DollarSign,
    title: "Track revenue",
    description:
      "Monitor your earnings with detailed financial reports and payouts.",
  },
  {
    icon: BarChart4,
    title: "Analytics dashboard",
    description:
      "Gain insights into audience behavior and sales performance.",
  },
];
    ...
    <section className="py-16 md:py-24 bg-slate-900">
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        <p className="text-slate-400 mt-4 max-w-2xl mx-auto text-lg">
          We provide a seamless platform for organizers to create, manage,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-12 md:mt-16">
          {features.map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700/60 
        ...
        <div className="mt-12 md:mt-16">
          <button
            type="button"
            className="group bg-primary text-white font-bold py-3 px-8 md:py-4 md:px-10 
            rounded-full hover:bg-secondary transition-all duration-300 
            text-base md:text-lg shadow-lg shadow-primary/20 
